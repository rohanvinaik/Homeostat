...
8. The **"SDIS" grounding document** — the founder's own attempt to grope toward the
   ...
   me; FIND IT before designing** (likely under `~/Projects/Predecessor_Study` or
...
> multifactorial condition like a polygenic condition, might be far more complex than the surface level,
...
> between a neurodevelopmental condition and a polygenic condition. The "SDIS" grounding document was my attempt to grope towards
