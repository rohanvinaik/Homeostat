...
## From `~/Projects/AuDHD_Correlation_Study` (SUBSUMED — founder's verdict: "not all that good")
...
| GWAS summary-statistics plumbing | Download/parse/harmonize for Grove 2019 ASD, ADHD meta-analyses | §13 needs sumstats handling for OpenGWAS/IEU; reuse the data plumbing, NOT the analyses | `candidate` |
